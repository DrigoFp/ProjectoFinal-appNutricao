...
app.get('/debug', (req, res) => res.json({ msg: "O server.js está atualizado!" }));

// ligar rotas
app.use(testRoutes); // api principal o servidor express, usa conjunto de rotas (testRoutes) dentro da aplicação principal. Liga essas rotas ao servidor
